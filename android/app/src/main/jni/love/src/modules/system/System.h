...
public:
	...
	virtual void googlePlayConnect() const;
	virtual bool isGooglePlayConnected() const;
    ...
    virtual void incrementAchievement(const std::string &id, int inc) const;
    virtual void submitScore(const std::string &id, double score) const;
