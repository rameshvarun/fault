...
{
#ifdef LOVE_ANDROID
    love::android::showAchievements();
#endif
}

void System::googlePlayConnect() const
{
#ifdef LOVE_ANDROID
   love::android::googlePlayConnect();
#endif
}

bool System::isGooglePlayConnected() const
{
#ifdef LOVE_ANDROID
   return love::android::isGooglePlayConnected();
#endif
}
...
{
#ifdef LOVE_ANDROID
   love::android::showLeaderboard(id);
#endif
}

void System::showAllLeaderboards() const
{
#ifdef LOVE_ANDROID
   love::android::showAllLeaderboards();
#endif
}
...
{
#ifdef LOVE_ANDROID
   love::android::unlockAchievement(id);
#endif
}

void System::incrementAchievement(const std::string &id, int inc) const
{
#ifdef LOVE_ANDROID
   love::android::incrementAchievement(id, inc);
#endif
}

void System::submitScore(const std::string &id, double score) const
{
#ifdef LOVE_ANDROID
   love::android::submitScore(id, score);
#endif
}
